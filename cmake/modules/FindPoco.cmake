...
#	find_package(Poco REQUIRED Util JSON XML Net Foundation)
#
# Important note:
#    While usage static library the order of POCO components is important. In first place you have to place
#    'Util' component, in last place 'Foundation' component.
#
...
list(APPEND components ${Poco_FIND_COMPONENTS})
...
foreach(component ${components})
    ...
    if(NOT Poco_${component}_LIBRARY_DEBUG)
        find_library(Poco_${component}_LIBRARY_DEBUG
            NAMES
                Poco${component}d
            HINTS
                ${Poco_ROOT_DIR}
...
if(${Poco_OSP_FOUND})
    ...
    find_program(Poco_OSP_Bundle_EXECUTABLE
        NAMES
            "bundle"
        HINTS
