...
public:
    ...
    DeviceGpio(DevicePinNum pin); //!< Construct class with specific number of pin.

    /*!
     * \brief Specify direction of pin.
     * \param dir specific direction.
     */
    void dir(DevicePinDirs dir);
     ...
     */
    unsigned long long count(DevicePinLevels level,
                             unsigned long long max = DEVICE_MAX_COUNT);
